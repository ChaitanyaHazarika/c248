...
class Block(object):
    def __init__(self):
        ...
        self.count = 0
        self.new_block(previous_hash="No previous Hash. Since this is the first block.", proof=470)  # Task 01 - Change the value of Proof
    ...
    def proof_of_work(self, previous_proof):
        ...
        while check_proof_condition is False:
            ...
            # Task-02 - Write the if condition here:
            if hash_proof[:2] == '00':
...
if blockchain.chain[0]['Current hash'] == blockchain.chain[1]['previous_hash']:
    ...
    print("Proof of work is not vailddddd")  
